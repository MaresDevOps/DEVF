...
export default function History() {
  ...
  return (
    <div className="flex flex-col h-full w-64 bg-gray-900 text-white p-4 border-r border-gray-700">
        ...
        <ul className="space-y-2 text-sm mt-4">
          {hook?.state?.messages?.map((msg, index) => (
            <li
              ...
              onClick={() => hook.dispatch({ type: "@current_chat", payload: msg.content })}
            >
              {msg.title}
            </li>
          ))}
