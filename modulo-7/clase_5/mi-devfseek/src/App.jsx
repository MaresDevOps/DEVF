...
export default function App() {
  ...
  const messages = hook.state.currentChat || [];

  const setMessages = (action) => {
    const nextState = typeof action === 'function' ? action(messages) : action;
    hook.dispatch({ type: "@current_chat", payload: nextState });
  };
  ...
  return (
    <div className="flex flex-col h-full flex-1 bg-gray-900 text-white justify-end">
